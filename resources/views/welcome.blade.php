...
<head>
    ...
    <style>
        ...
        .nav-link::after {
            ...
            /* Màu hồng giống border-pink-500 */
            transition: width 0.3s ease-in-out;
            /* Hiệu ứng mượt mà cho width */
        }

        .nav-link.active::after {
            width: 100%;
            /* Khi active, width mở rộng 100% */
        }
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                @forelse($featuredProducts as $product)
                    <div
                        class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 card-hover group">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                @else
                                    <button class="bg-gray-300 text-gray-500 px-4 py-2 rounded-lg cursor-not-allowed text-sm"
                                        disabled>
                                        Hết hàng
                                    </button>
                                @endif
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-2xl p-8 card-hover">
                    ...
                    <p class="text-gray-600 mb-6 italic">"Dịch vụ giao hàng rất nhanh và bánh vẫn giữ được độ tươi ngon.
                        Tôi rất hài lòng với chất lượng sản phẩm tại đây."</p>
                    <div class="flex items-center">
                        <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=64&h=64&fit=crop&crop=face"
                            alt="Trần Văn Nam" class="w-12 h-12 rounded-full mr-4">
                        <div>
                ...
                <div class="bg-gray-50 rounded-2xl p-8 card-hover">
                    ...
                    <p class="text-gray-600 mb-6 italic">"Tôi đã đặt bánh sinh nhật cho con và mọi người đều khen ngon
                        lắm. Thiết kế bánh cũng rất đẹp mắt."</p>
                    <div class="flex items-center">
                        <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=64&h=64&fit=crop&crop=face"
                            alt="Lê Thị Hoa" class="w-12 h-12 rounded-full mr-4">
                        <div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400 mb-4">Bánh ngọt tươi ngon được làm với tình yêu và sự tận tâm từ năm 2014.
                    </p>
